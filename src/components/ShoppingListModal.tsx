  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-md max-h-[85vh] overflow-hidden shadow-2xl relative z-10 animate-in zoom-in-95 duration-200 flex flex-col border border-slate-100 dark:border-slate-800">
        ...
        {/* Header */}
        <div className="p-4 border-b border-slate-100 dark:border-slate-850 flex justify-between items-center bg-slate-50 dark:bg-slate-900 sticky top-0 z-10">
                      ...
                      return (
                        <div
                          ...
                          className={`flex items-center gap-3 p-3 rounded-xl border transition-all cursor-pointer select-none ${
                            isChecked
                              ? "bg-slate-50/50 dark:bg-slate-800/30 border-slate-100 dark:border-slate-850 opacity-60"
        ...
        {/* Footer Actions */}
        {hasItems && (
          <div className="p-4 border-t border-slate-100 dark:border-slate-850 bg-slate-50 dark:bg-slate-900/50 flex gap-2 z-10 no-print">
            <button
              onClick={handleCopy}
              className="flex-1 py-2.5 rounded-xl border border-slate-200 dark:border-slate-750 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-250 font-bold text-xs flex items-center justify-center gap-1.5 transition-all"
            >
              {copied ? (
                <>
